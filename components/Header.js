    ...
    return (
        <header className='sticky top-0 z-50 grid
         grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10'>
           ...
           {/*middle header div*/}
           <div  className="flex items-center border-2 rounded-full py-2 md:border-2 md:shadow-xl">
              <input 
              value={searchInput}
            ...
            <SearchIcon className=" hidden md:inline-flex h-8 bg-red-400
             text-white rounded-full p-2 cursor-pointer md:m2-2"/>
           </div>
           {/*right header div*/}
           ...
           {searchInput && (
              <dive className="flex flex-col col-span-3 mx-auto mt-6">
                  <DateRangePicker
                  ...
                  <div className="flex items-center border-b mb-4">
                      ...
                      className="w-12 pl-4 text-lg outline-none text-red-900 rounded-full"
                      min={1}
                      type="number"/>
                  </div>
                  <div className="flex">
